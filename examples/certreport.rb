...
options = GetoptLong.new(
  ...
  [ "--expiring",       "-e", GetoptLong::NO_ARGUMENT ],
...
def usage 
  ...
  puts "  -e (--expiring)        only show expiring certificates within watermark-days"
...
certs.select! {|k,v| v['expire_text'].eql?(cert_validity_label("VTYPE_CERTIFICATE_WILL_EXPIRE"))} if expiring
